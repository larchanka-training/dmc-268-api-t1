...
Нужны **Docker Engine** на целевом хосте и OpenTofu >= 1.12 (в CI ставится 1.12.6). Образ API не собирается здесь: он публикуется в ghcr из CI и забирается по тегу (`api_image`).
